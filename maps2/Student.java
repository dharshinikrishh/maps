...
public class Student implements Comparable<Student>{
	...
	public Student(int rollNum, String name, String stream, StudentDetails profile, List<Subject> allSubjects,
			List<Certificates> allCertificates) {
		super();
		this.rollNum = rollNum;
		this.name = name;
		this.stream = stream;
	...
	public void setAllCertificates(List<Certificates> allCertificates) {
		this.allCertificates = allCertificates;
	}
	@Override
	public int hashCode() {
		final int prime = 31;
		int result = 1;
		result = prime * result + ((allCertificates == null) ? 0 : allCertificates.hashCode());
	...
	public boolean equals(Object obj) {
		...
		if (allCertificates == null) {
			if (other.allCertificates != null)
				return false;
		} else if (!allCertificates.equals(other.allCertificates))
			return false;
		if (allSubjects == null) {
