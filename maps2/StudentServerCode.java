...
public class StudentServerCode {
  ...
  ///       stream has number students 	
	...
	public Student addStudentCertificates(Student student, List<Certificates> certificates)
	{
		
		
			student.setAllCertificates(certificates);
			return student;
		
	}
	public List<Student>getStudentByRollNumberAndStream(int rollNumber,String stream)
	{
		List<Student> allStudentsOfMarks = colg.get(rollNumber);
		return null;
	...
	{
		List<Student> allStudentsOfStudentDetails = colg.get(state);
		return allStudentsOfStudentDetails;
